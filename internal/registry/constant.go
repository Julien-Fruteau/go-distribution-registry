...
const (
	...
	MIME_V2_CONTAINER_CONFIG_JSON = "application/vnd.docker.distribution.manifest.list.v2+json"
	MIME_V2_LAYER_GZIP            = "application/vnd.docker.distribution.manifest.list.v2+json"
